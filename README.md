...
In [this wiki page](https://github.com/JotaroS/dualpantoframework/wiki/Installation-&-Setup), we introduce you how to install the library in your system. Follow these steps to install required dependencies for `dualpantoframework`.
