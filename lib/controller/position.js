 ...
 * @prop {number} movementID the movement id prevents multiple movements at the same time
 * @prop {Vector} target the current movement target
...
class PositionController {
	 ...
	 * @param {Object} [options={}] movement options (see {@link Handle#moveTo})
	 */
