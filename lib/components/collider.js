...
class Collider extends Component {
   ...
   * called during the respective collider sublass' init.
   * @param {number} index - The index of the handle on which the obstacle
   * should be created, with -1 meaning both handles. Defaults to the handle(s)
  ...
  remove(index) {
    ...
    usedObstacleIds.remove(this.id);
  }
