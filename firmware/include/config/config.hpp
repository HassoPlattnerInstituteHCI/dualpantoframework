...
constexpr uint32_t hashtableUsedMemory = 9600;
constexpr uint32_t hashtableMaxCells = 8333;
constexpr uint32_t hashtableNumCells = 1829;
constexpr uint32_t hashtableStepsX = 36;
constexpr uint32_t hashtableStepsY = 21;
constexpr double hashtableStepSizeX = 10.0;
constexpr double hashtableStepSizeY = 10.0;
